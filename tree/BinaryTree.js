...
class BST {
  ...
  insert(value) {
    ...
    const searchAndInsert = (node) => {
      // if value < node.value, go left
      if (value < node.value) {
        if (!node.left) {
          node.left = newNode;
        }
        // if contains left child, look left again
        else {
...
console.log("CONTAINS 28=", bst.contains(28));
console.log("CONTAINS 39=", bst.contains(29));
